  ...
  function init() {
    hot1 = new Handsontable(container, {
      ...
      cell: [
        ...
        // 3
        {row: 1, col: 10, className: "cell-dark"},
        {row: 2, col: 10, className: "cell-dark"},
        {row: 3, col: 10, className: "cell-dark"},
        {row: 4, col: 10, className: "cell-dark"},
        {row: 5, col: 10, className: "cell-dark"},
        {row: 6, col: 10, className: "cell-dark"},
        {row: 7, col: 10, className: "cell-dark"},
        {row: 8, col: 10, className: "cell-dark"},
        {row: 1, col: 9, className: "cell-dark"},
        {row: 4, col: 9, className: "cell-dark"},
        {row: 5, col: 9, className: "cell-dark"},
        {row: 8, col: 9, className: "cell-dark"}
      ]
    });
  }
